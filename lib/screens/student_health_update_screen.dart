...
class StudentHealthProfileScreen extends StatefulWidget {
  ...
  StudentHealthProfileScreen({
    required this.studentId,
    required this.fatherQatarId,
  });

  @override
  _StudentHealthProfileScreenState createState() => _StudentHealthProfileScreenState();
}
  ...
  void initState() {
    ...
    controller = WebViewController()
      ...
      ..loadRequest(Uri.parse(
        'https://pers.tngqatar.online/Module/HWB/MedicalProfile.php'
            '?SearchStudentID=${widget.studentId}'
            '&SearchFatherQID=${widget.fatherQatarId}',
      ));
  }
